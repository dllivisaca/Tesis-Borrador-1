...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $update_sql = "UPDATE citas SET fecha = '$fecha', hora_inicio = '$hora_inicio', hora_fin = '$hora_fin' WHERE citaid = $citaid AND pacid = $userid";
        if ($database->query($update_sql) === TRUE) {
            echo "<script>alert('Cita actualizada correctamente'); window.location.href = 'citas.php';</script>";
        } else {
